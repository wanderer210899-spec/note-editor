        ...
        <div class="ne-workspace">
            ...
            <section class="ne-editor-shell">
                <div class="ne-format-bar" id="ne-format-bar" aria-label="${t('editorShell.formatBar.aria')}">
                    ...
                    <button class="ne-btn ne-btn--soft ne-btn--format" type="button" data-format="quote" title="${t('editorShell.format.quote')}" aria-label="${t('editorShell.format.quote')}">"</button>
